...
# Match by reference, not by value — at plan time the bucket name is
# "(known after apply)" so planned_values.bucket is null. Instead read
# the expression reference strings that Terraform resolves at apply time.
