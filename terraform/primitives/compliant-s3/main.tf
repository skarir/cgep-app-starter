# main.tf
# Lab 2.3 â€“ First Compliant Resource (AWS S3)
...
provider "aws" {
  ...
  # CM-6: Configuration settings â€“ required compliance tags applied to every
...
# SC-28 REMOVED — intentional violation for red-PR demo
...
# AC-3: Access control â€“ explicit deny on every public access vector.
